 ...
 * @attention
 *
 * Copyright (c) 2022- VAct technologies pvt ltd
 *
 * Experiment 1
 *
 * Using filter configuration, set both the LSB and MSB values
 * of the FIR(Filter Identifier Register).
 *
 *
...
int main(void)
{
  ...
  sFilterConfig.FilterIdHigh = 0x65D;
  sFilterConfig.FilterIdLow = 0x651;
