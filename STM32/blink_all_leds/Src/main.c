 ...
 * @brief          : Blink All LEDs As Binary Counter
 ******************************************************************************
 * @attention
 *
...
void blink_led(uint32_t *ptr_GPIOC_ODR, uint32_t *ptr_GPIOB_ODR)
{
  ...
  while (1)
  {
    ...
    {
      *ptr_GPIOB_ODR &= ~(0x01 << 13); // Turn LED2 ON
    }
    else
    {
      *ptr_GPIOB_ODR |= (0x01 << 13); // Turn LED2 OFF
    }
    ...
    {
      *ptr_GPIOB_ODR &= ~(0x01 << 15); // Turn LED4 ON
    }
    else
    {
      *ptr_GPIOB_ODR |= (0x01 << 15); // Turn LED4 OFF
    }
